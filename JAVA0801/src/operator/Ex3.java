...
public class Ex3 {
	...
	public static void main(String[] args) {
		/*
		 * 문자열에 대한 덧셈연산자(+) = 연결(결함) 연산자
		 * - 어떤 데이터를 문자열과 덧셈연산자로 연살할 경우
		...
		String str = "a = " + a; // String 문자열까지 저장하능한 코드
		...
		System.out.println(10 + "20" + 30); // "102030" 문자열 결합 ('→' 방향으로 인식시작)
		...
		String name = "강진석"; // String : 문자열을 저장할 수 있는 타입
		int age = 20;
...
//		long jumin = 9010101234567L; // long 타입으로 표현하거나
		String jumin = "901010-1234567"; // String 타입으로 주민번호를 문자열로 인식하게 표현
