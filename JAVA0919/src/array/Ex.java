...
public class Ex {
	...
	public static void main(String[] args) {
		 ...
		 * => 배열 공간이 생성되기 전이므로, 아직 데이터 저장을 불가
		 * => 선언된 배열의 변수는 참조형 변수로 취급됨
		 * 	  (주의! int는 기본형이지만, int[]은 참조형)
		 * 
		 * < 배열의 생성 기본 문법 >
		 * 변수명 = new 데이터타입[배열크기];
		 * => new 키워드를 이용하여 배열 공간을 생성하는데
		...
		// 학생 점수 5개를 별도로 변수에 저장하고 관리하는 경우
...
//		score = new int[5];
		...
		// 배열에 접근하여 각 배열 공간에 데이터 출력
		// => 배열명이 score 이므로 score[인덱스] 형식으로 접근
		System.out.println(score); // 배열명을 그대로 출력 시 주소값 출력(데이터x)
		...
		// => 이때, 배열은 자동으로 기본값으로 초기화 되므로 0 출력됨
...
//		System.out.println(score[5]); // 실행 시 오류 발생!
		...
		// at JAVA0919/array.Ex.main(Ex.java:89)
...
//			System.out.println(score[i]); //score[0] ~ score[4] 까지 대응
		...
		int arr3, arr4[]; // arr3은 int, arr4는 int[] 타입 변수 선언됨
