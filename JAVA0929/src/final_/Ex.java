...
//		Math.PI = 3.14; // 컴파일러 에러 발생! 값 변경 불가!
...
class FinalMember{
	...
	// blank final 상수를 초기화 하는 생성자 정의 필수!
...
//		finalMember=99; // final 키워드가 붙은 변수(=상수)는 값 변경 불가!
		...
		final int finalLocalVar = 20; // 로컬변수에서도 fianl 변수 사용 가능
//		finalLocalVar =99; // => 값 변경 불가
	}
	
	// 기본 값 변경을 불가능하지만 사용은 가능함
