...
public class Ex4 {
	...
	public static void main(String[] args) {
		 ...
		 * 5) Employee4 인스턴스가 생성되고, Employee() 생성자 내의 코드 실행됨
...
class Employee4{
	...
	public Employee4() {
		super(); // Object를 상속하여 기본생성자를 생성
		System.out.println("Employee4() 생성자 호출됨");
	}
	// 만약, 파라미터 생성자를 정의했을 때 기본 생성자가 자동으로 생성되지 않으므로
	// 서브클래스의 생성자에서 기본적으로 호출되는 슈퍼클래스의 기본 생성자가 존재하지
	// 않음! 서브클래스의 생성자에서 컴파일에러가 발생할 수 있다!
...
// Employee4 클래스를 상속받는 서브클래스 Manager4 정의
 class Manager4 extends Employee4{
	...
	public Manager4() {
		...
		// => 슈퍼클래스 생성자의 작업이 종료된 후 서브클래스의 생성자 작업 수행
