...
public class Ex3 {
	...
	public static void main(String[] args) {
		...
		GenericClass3<Integer> gc; // Integer 는 Number의 하위타입이므로 지정 가능
...
// 부모 타입에 제네릭타입이 지정되어 있는 경우
// 서브클래스에서 상속받을 때 부모의 타입 파라미터를 서브클래스 타입 파라미터로 
// 명시해야 한다!
class SubClass<R, P, Q> extends Class1<P> implements Interface1<Q> {
	// => Class1<P>, Interface<Q> 을 상속받으려면 최소한 SubClass 뒤에 P 와 Q 를 명시 필수!
...
//class GenericClass3<E> {} // 타입 파라미터 E는 어떤 타입으로도 변경 가능함
