...
public class Ex3 {
	public static void main(String[] args) {
		 ...
		 * 3. 서로 상속 관계가 없는 클래스 간의 인터페이스를 통한 상속 관계 부여
		 * 	  => 다형성 확장
		...
		// 각 프린트기 인스턴스를 파라미터로 전달하면 업캐스팅 일어남
		pc.setPrinter(new LaserPrinter()); // LaserPrint -> Printer 업캐스팅
		...
		pc.print("Ex3.java");
		// 출력결과  : Dot Printer로 Ex3.java 출력하기
...
class PrinterClient {
	...
	public void print(String fileName) {
		...
		// printer() 메서드 호출하면 해당 프린터의 출력 기능을 사용 가능함
