...
public class Ex {
	...
	public static void main(String[] args) {
		...
		// Setter 를 호출하여 값을 저장할 때 직접 입력하지 않고
...
class CarInfoWithConstant {
	...
	//    static 에 의해 클래스명만으로 인스턴스 생성없이 접근 가능하고,
	...
	public static final int CLOLR_CREAM_WHITE = 0xFFFFCC;
	public static final int CLOLR_BARCELONA_RED = 0xFF0000;
