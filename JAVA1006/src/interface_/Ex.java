...
public class Ex {
   ...
   public static void main(String[] args) {
       ...
       * - 서브클래스(구현크래스)에서 인터페이스를 상속받아 구현해야 하는 경우
       *   extends 키워드 대신 implement 키워드를 사용
       ...
       *   => implements 키워드 뒤에 복수 개의 인터페이스 지정 가능
...
//      msc.NUM1 = 99; // 변경 불가!
      ...
      //	인터페이스 가진 모든 메서드는 참조 영역 축소 후에도 호출 가능!
      mi2.method1();
      mi2.method2();
      mi2.method3();
...
interface MyExInterface {
   // 인터페이스 내의 모든 멤버변수는 상수(public state final) 이다!
   public static final int NUM1 = 10; // 상수
   int NUM2 = 20; // 상수(public state final 생략되어 있음)
...
//   public MyExInterface() {} // 컴파일 에러 발생!
   ...
   public abstract void method1(); // 컴파일 에러 발생!
