...
//		ac.subClassMethod(); // 참조영역의 축소로 보이지 않는 메서드 // 에러발생
...
abstract class Animal {
	public abstract void cry(); // 바디{}가 없음
}

class Cat extends Animal {
	// The type Cat must implement the inherited abstract method Animal.method()
	// => 상속된 추상클래스Animal의 메서드를 반드시 "구현 = 재정의 = 오버라이딩" 해야한다.
	public void cry(){ // 메서드 구현 시 abstract 생략 필수
...
abstract class AbstractClass{
	// public abstract class AbstractClass() {} 오류발생!
