...
public class Ex {
	...
	public static void main(String[] args) {
		 ...
		 * - 리턴타입을 명시한 메서드는 반드시 return문을 사용하여 데이터를 리턴
		 * 	 => 단, 리턴타입이 void 인 메서드는 return 문을 생략해도 되고
		 * 		리턴값 없이 return문만 기술할 수 있다!
		 * 	 => 메서드 내에서 return 문을 만나면 즉시 메서드를 종료하고 돌아감
		 * 	 => if 문 들의 조건식을 사용하여 return 문을 실행할 경우
		 *      반드시 어떤 경우에서 return 문이 실행되도록 조건식을 작성해야함
		 * 	
...
//		sister_2();
		...
		//	  Stirng 타입 변수 result 에 저장(String result= "물"과 동일함)
		System.out.println("동생이 가져다 준 것 : " + result);
		
		// 리턴값을 변수에 저장하지 않고 직접 사용도 가능
		System.out.println("동생이 가져다 준것 : " + sister_2());
	...
	// 	  (void =  리턴값이 없다는 의미) 리턴안하고 메서드기능만하고 끝.
		...
		// ---------------------------메서드 정의-------------------------------------
		// 2. 파라미터는 없고, 리턴값만 있는 메서드 호출
		// => 메서드 파라미터가 없으므로 선언수 소괄호() 안에 아무것도 명시하지 않음
