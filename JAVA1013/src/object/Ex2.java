...
//		System.out.println(str.toString()); // 위의 결과와 동일함 (문자열 출력)
		...
		System.out.println(" 사람 p의 정보 : " + p.toString()); // object.Person2@fad74ee
		System.out.println(" 사람 p의 정보 : " + p); // 결과동일
		...
		System.out.println("p2 객체의 정보 : " + p2); // toString() 생략됨
