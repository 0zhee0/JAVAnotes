...
public class Ex {
	...
	public static void main(String[] args) {
		 ...
		 * 	 => 전달받는 인자(데이터)의 개수에 따라 자동으로 배열로 관리
...
class VariableArguments{
	...
	// 다른 파아미터와 가변 인자 조합 가능
	public void print2(int num, String...names) {}
	// => int 형 데이터 1개와 문자열 데이터 여러개를 전달 가능
	// 	  ex) print2(2, "홍길동", "이순신");
...
//	public void print3(String...names, int num,) {} // 오류 발생!
	...
	// 가변 인자가 2개 이상 올 수 없다!
//	public void print4(int...num, String...names) {} // 오류발생!
}
...
class NormalArguments {
	...
	// 파라미터 String타입 배열을 선언하는 경우
	public void print(String[] names) { // 매개변수로 배열을 선언
