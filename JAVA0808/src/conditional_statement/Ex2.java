...
public class Ex2 {
	...
	public static void main(String[] args) {
		 ...
		 *   switch 문이 종료될 때 까지 현재 문장의 아래쪽 모든 실행 문장을 실행
		 *   (다른 casem 문과 default 문의 실행문까지 모두 실행)
		 * - case 문끼리의 순서는 무관함
		 *      
		 *   
		 * < 기본 문법 >
		...
		switch(num) {
			...
			// num이 2 일 때 case 2 의 문장을 실행하고 break 문이 없이 때문에
			// 아래쪽 case 3 의 문장도 모두 실행된다!
