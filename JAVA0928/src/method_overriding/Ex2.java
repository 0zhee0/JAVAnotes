...
class Parent{
	...
	public Object parentPrn2() {
		...
		return null; // retutn 값에 어떤 타입을 넣어도 가능
					 // return할 값을 특정할 수 없을 때 리턴타입을 Object로 적으면된다.
	}
...
class Child extends Parent{
	...
	// => 부모가 public일 경우 자식은 무조건 public 만 지정가능!
...
//	}
	...
	// -------------------------------------------------------------------------------
	// 오버라이딩 시 슈퍼클래스의 리턴타입대신 서브클래스 타입을 명시할 수 있다!
...
//	public Object parentPrn3() { //컴파일에러 발생!
//		System.out.println("서브클래스에서 오버라이딩 된 parentPrn3()");
//		return null;
//	}
	
	// 오버라이팅 단축키 : Alt Shift S + V
	@Override
	public String parentPrn3() {
...
class Student2 extends Person2{
	...
	// 주의! @Override 어노테이션(Annotation)이 붙어있을 경우에는
