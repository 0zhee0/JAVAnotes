...
public class Ex2 {
	...
	public static void main(String[] args) {
		 ...
		 * 		생성자 작성 규칙에 위배됨
		 * - 서브클래스의 인스턴스 생성할 때는, 자동으로 슈퍼클래스의 인스턴스를
		 * 	 먼저 생성한 후 서브믈래스의 인스턴스가 생성됨
		 ...
		 * 				서브클래스 생성자에 슈퍼클래스 기본 생성자 호출 불가로
...
//		super(); // 암묵적으로 생성자내에 포함됨.
		...
		// 서브클래스에서 슈퍼 클래스의 파라미터 생성자를 명시적으로 호출(2)
//		super("홍길동", 20);
//		isStudyMode = true;
