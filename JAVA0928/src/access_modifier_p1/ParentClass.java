...
public class ParentClass {
		 ...
		 * 3. dafault : 같은 패키지에서만 접근 가능(= 다른 패키지에서 접근 불가)
		...
		public void useMember() {
			...
			this.publicVar = 10;		// public(0)
			this.protectedVar = 20; 	// protected(0)
			this.defaultVar = 30;		// default(0)
			this.privateVar = 40;		// private(0)
		}
