...
//      char[] chArr = {'a', 'd', 'm', 'i', 'n', '1', '2', '3'};   ---1
      String str = "itwill";
      // String 타입 문자열을 char 타입 배열로 변환 : toCharArray() 사용   --- 2
      char[] chArr = str.toCharArray();
      
      // enrypt() 메서드 다 입력한 후에 main()메서드로 돌아와서	---4
...
//      char[] chArr = {'a', 'd', 'm', 'i', 'n', '1', '2', '3'};
      ...
      for(int i = 0; i < chArr.length; i++) {
         ...
         enryptedArr[i] = (char)(chArr[i] + 3); // 연산결과가 int라서 char타입으로 형변환 시켜준다.
      }
