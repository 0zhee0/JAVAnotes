...
public class Ex3 {
	...
	public static void main(String[] args) {
		 ...
		 * < 권장사항 >
		 * 6. 의미가 있는 단어 사용
		 * 7. 변수명의 첫단어는 소문자로 작성하고, 두번째 단어부터는 첫 글자는 모두 대문자로 작성
		 * 	  => Camel-case 표기법 사용
		 *    ex) studentName
...
//		int 7eleven; // 사용 불가
		...
		int $ystem; // 사용 가능
		int my_name; // 사용 가능
//		int channel#5; // 사용 불가($ 또는 _만 가능)
		// => (Syntax error on token "Invalid Character", = expected) : 유효하지 않은 문자
		
		// 3. 대소문자 구별
		int age; // 소문자 age와
		int AGE; // 대문자 AGE는 다른 식별자로 취급된다.
