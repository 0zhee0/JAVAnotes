...
public class Ex {
	...
	public static void main(String[] args) {
		...
		for(i=1; i <=10; i++) {
			...
			// i 값이 5 일 때 for 문을 빠져나감
			if(i == 5) {
				System.out.println("i = 5 이므로 for문을 종료합니다.");
				break;
			}
		}
		...
		while(i <= 10) {
			System.out.println(i);
			// i 값이 5 일 때 while 문을 빠져나감
			if(i == 5) {
				System.out.println("i = 5 이므로 while문을 종료합니다.");
				break;
			}
			i++;
		}		
		...
		for(i = 1; i <= 10; i++) {
			...
			// i값이 5일 때 출력문 실행을 생략하고 다음 반복을 진행
			if(i == 5) {
				System.out.println("i = 5 이므로 출력문 실행을 생략");
				continue;
			}
			System.out.println(i); // i 값이 5 일 때 출력문이 실행되지 못함
