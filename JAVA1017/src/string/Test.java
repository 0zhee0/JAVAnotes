...
public class Test {
	...
	public static void main(String[] args) {
		...
		String jumin = "031010-1234567";
		
		// 주민등록번호 뒷자리 첫번째 숫자 추출 => 문자로 저장
//		System.out.println(jumin.charAt(7)); // '1'
		...
		switch(genderNum) {
			...
			case '5' : 
			case '6' : System.out.println(jumin + " : 왼국인! "); break; 
